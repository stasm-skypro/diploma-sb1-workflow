# user/scripts/add_user.py
"""
Начальная инициализация базы данных - скрипт для добавления пользователей.
В отличие от фикстур добавляет пользователей с исходными паролями, а не хэшами.
"""
